...
public class BrincandoComOrdenacao {
    ...
    static final int HEAP = 6;

    //  MAIN
    public static void main(String[] args) {
        long[][][] table = new long[7][3][2];        //  TABELA DE RESULTADOS
        int vetores[][][] = criaVetores();          //  VETORES DE TESTE
        
        //  PARA CADA ALGORITMO i (0=BUBBLE; 1=SELECTION; 2=INSERTION; 3=MERGE; 4=QUICK; 5=COUNTING; 6=HEAP)
        for (int i = 0; i <= 6; i++) {
...
//**************************************************
    ...
    public static void heapfy(int [] vetor, int node, int last){
        ...
        if (node == maior) return;
        
        swap(vetor, node, maior);
        heapfy(vetor, maior, last);
    ...
    public static void printTable(long[][][] table, int tamanho) {
        String[] algNames = new String[]{"BUBBLE SORT", "SELECTION", "INSERTION", "MERGE SORT", "QUICK SORT", "COUNTING", "HEAP SORT"};
